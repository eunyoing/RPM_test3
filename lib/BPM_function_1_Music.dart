...
await session.configure(AudioSessionConfiguration.music()); // 🔥 이게 핵심
...
if (oldWidget.bpm != widget.bpm || oldWidget.songs != widget.songs) {
if (widget.songs.isNotEmpty && currentSong.audioPath != widget.songs[0].audioPath) {
setState(() {
currentIndex = 0;
});
Future.microtask(() {
